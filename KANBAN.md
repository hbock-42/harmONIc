...
| E4-76 | P3 | The two critters with no wild form | 37 of the 39 tame critters here have a wild twin; the Glo Squid and the Seaquine do not, and both are Aquatic. Found while rendering the inspector for a Glo Squid and expecting the row of other ways to keep it, which correctly was not there. A wild one is a real thing you meet in the game, so this is a gap in the data rather than a rule. Wants the usual pair: what it eats and what it lays untamed |
