...
| E4-69 | P3 | The Cuddle Pip | reported: a Pip that eats Arbor Tree turns into one, so a build with grazed Arbor Trees grows them whether you meant to or not. Wants the morph's own diet, yields and egg rate |
