...
const String oniDataJson = r"""
{
  ...
  "processes": [
    ...
    {
      "id": "smoker_brisket_wood",
      "name": "Smoker (Tender Brisket, Wood)",
      "kind": "building",
      "buildingId": "smoker",
      "powerWatts": 0,
      "heatKdtuPerSecond": 9,
      ...
      "footprintWidth": 4,
      "footprintHeight": 3,
      "description": "UNVERIFIED: six kilograms of tough meat make 16 000 kcal of tender brisket over ten cycles, burning 100 kg of wood to do it. The page gives the fuel as \"either Peat or Wood\" in a note under the recipes, so there is one of these per fuel rather than an invented \"peat or wood\" material — the game has no such thing. It draws no power and needs a Duplicant to unload it, for a time nobody has published, so the labour is left at nothing rather than guessed.",
      "tags": [
        "food",
        "prehistoric",
        "unverified"
    ...
    {
      "id": "smoker_brisket_peat",
      "name": "Smoker (Tender Brisket, Peat)",
      "kind": "building",
      "buildingId": "smoker",
      "powerWatts": 0,
      "heatKdtuPerSecond": 9,
      ...
      "footprintWidth": 4,
      "footprintHeight": 3,
      "description": "UNVERIFIED: six kilograms of tough meat make 16 000 kcal of tender brisket over ten cycles, burning 100 kg of peat to do it. The page gives the fuel as \"either Peat or Wood\" in a note under the recipes, so there is one of these per fuel rather than an invented \"peat or wood\" material — the game has no such thing. It draws no power and needs a Duplicant to unload it, for a time nobody has published, so the labour is left at nothing rather than guessed.",
      "tags": [
        "food",
        "prehistoric",
        "unverified"
