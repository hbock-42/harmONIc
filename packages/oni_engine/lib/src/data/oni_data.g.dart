...
const String oniDataJson = r"""
{
  ...
  "processes": [
    ...
    },
    {
      ...
      "footprintWidth": 2,
      "footprintHeight": 2,
      "description": "A kilogram of polluted dirt a second becomes 660 g of polluted oxygen. The third of it that goes missing is the game deleting mass, not an error here.",
      "tags": [
        "oxygen",
        "verified"
      ],
    ...
    {
      "id": "gas_range_mixed_berry_pie_grubfruit",
      "name": "Gas Range (Mixed Berry Pie, grubfruit)",
      "kind": "building",
      "buildingId": "gas_range",
      "powerWatts": 240,
      "heatKdtuPerSecond": 9,
      ...
      "footprintWidth": 3,
      "footprintHeight": 3,
      "description": "The pie takes one berry of four, and each in its own amount — 4 kg of grubfruit, 1 of gristle berry, 1.66 of pikeapple skewer, 6.15 of ovagro fig — so they are four recipes rather than one port with a choice. One kilogram out every 50 s, with a Duplicant at it: the rates assume one standing there the whole cycle, and 100 g/s of natural gas burnt for 25 of carbon dioxide whatever is cooking.",
      "tags": [
        "food",
        "verified",
        "spacedout"
