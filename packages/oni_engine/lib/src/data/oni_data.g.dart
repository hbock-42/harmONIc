...
const String oniDataJson = r"""
{
  ...
  "processes": [
    ...
    },
    {
      ...
      "footprintWidth": 4,
      "footprintHeight": 3,
      "description": "UNVERIFIED: six kilograms of tough meat make 16 000 kcal of tender brisket over ten cycles, and every recipe on this building also burns 100 kg of \"either Peat or Wood\" — the page says so under the table rather than in the recipe, which is easy to miss. Either does, in the same amount, so the port asks for the pair of them. It draws no power and needs a Duplicant to unload it, for a time nobody has published, so the labour is left at nothing rather than guessed.",
      "tags": [
        "food",
        "prehistoric",
        "unverified"
