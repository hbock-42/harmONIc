...
const String oniDataJson = r"""
{
  ...
  "processes": [
    ...
    {
      "id": "aquatuner_water",
      "name": "Aquatuner (Water)",
      "kind": "building",
      "buildingId": "aquatuner",
      "powerWatts": 1200,
      "footprintWidth": 2,
      "footprintHeight": 2,
      "description": "Takes 14 C out of every packet of liquid and puts it into the machine, which is why one usually stands in a steam room with a turbine over it. It moves heat rather than destroying it: the figures here are for water at a full pipe, 10 kg/s * 4.179 * 14 C = 585.06 kDTU/s. Another coolant moves a different amount, which is why this is water in particular rather than \"any liquid\".",
      "tags": [
        "cooling",
        "verified"
      ],
    ...
    {
      "id": "thermo_regulator_hydrogen",
      "name": "Thermo Regulator (Hydrogen)",
      "kind": "building",
      "buildingId": "thermo_regulator",
      "powerWatts": 240,
      "footprintWidth": 2,
      "footprintHeight": 2,
      "description": "The gas version, and the same trade: 14 C off each packet, moved into the machine rather than destroyed. Hydrogen at 1 kg/s carries 33.6 kDTU/s of it. A colder-running gas would move less.",
      "tags": [
        "cooling",
        "verified"
      ],
